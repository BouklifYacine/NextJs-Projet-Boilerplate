      ...
      <Card className="p-6">
        ...
        >
          <div className="space-y-2">
            ...
            <InputPassword {...formulaireVerification.register("motdepasse")} />
          ...
          <div className="flex gap-2">
            ...
            >
              {mutationVerifierMotDePasse.isPending
                ? "Vérification..."
                : "Continuer"}
            </Button>
            <Button
  ...
  return (
    <Card className="p-6">
      ...
      >
        ...
        <div className="flex gap-2">
          <Button type="submit" disabled={mutationChangerPseudo.isPending}>
            {mutationChangerPseudo.isPending
              ? "Modification..."
              : "Changer le pseudo"}
          </Button>
