...
const Faq = () => {
  return (
    <div id="faq" className="pb-20 scroll-mt-20">
              ...
              <Accordion type="single" collapsible className="w-full">
                <AccordionItem value="item-1" className="border-b-0">
                  ...
                  <AccordionContent className=" text-sm md:text-base px-1 md:px-2">
                    Pour commencer, il suffit de créer un compte gratuit sur
                    Github Ensuite fork le projet
                  </AccordionContent>
                </AccordionItem>
              </Accordion>
            </div>
            ...
            <div className="backdrop-blur-xs rounded-3xl md:rounded-2xl p-4 dark:shadow-blue-500 shadow-md shadow-blue-500">
              <Accordion type="single" collapsible className="w-full">
                <AccordionItem value="item-2" className="border-b-0">
                  ...
                  <AccordionContent className=" text-sm md:text-base px-1 md:px-2">
                    Système de connexion avec providers et credentials,
                    dashboard admin système de mailing et de payement voir le
            ...
            <div className="backdrop-blur-xs rounded-3xl md:rounded-2xl p-4 dark:shadow-blue-500 shadow-md shadow-blue-500">
              <Accordion type="single" collapsible className="w-full">
                <AccordionItem value="item-3" className="border-b-0">
                  ...
                  <AccordionContent className=" text-sm md:text-base px-1 md:px-2">
                    Oui le site est en version 0.6 donc des nouvelles
                    fonctionnalités prévues voir le readme
                  </AccordionContent>
                </AccordionItem>
              </Accordion>
            </div>
            ...
            <div className="backdrop-blur-xs rounded-3xl md:rounded-2xl p-4 dark:shadow-blue-500 shadow-md shadow-blue-500">
              <Accordion type="single" collapsible className="w-full">
                <AccordionItem value="item-3" className="border-b-0">
                  ...
                  <AccordionContent className=" text-sm md:text-base px-1 md:px-2">
                    NextJS TypeScript AuthJS Resend Stripe Prisma PostgreSQL en
                    autre
                  </AccordionContent>
                </AccordionItem>
              </Accordion>
